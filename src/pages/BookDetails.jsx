...
const BookDetails = () => {
    ...
    const handleAddNote = async() => {
        ...
        const updatedNotes = [...notes, response.data.data];
        localStorage.setItem(`bookNotes_${id}`, JSON.stringify(updatedNotes));
        setNewNote('');
                        ...
                        <div className="md:w-2/3 p-8">
                            <div className="flex justify-between items-start">
                                ...
                                <div className="flex items-center bg-yellow-50 px-4 py-2 rounded-full shadow-sm border border-yellow-100">
                                    <div className="flex text-amber-400">
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            <svg key={star} className="w-5 h-5" fill={star <= 4 ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="mt-8">
                                <h2 className="text-xl font-semibold text-gray-800 mb-3">
                                    <svg className="w-5 h-5 mr-2 text-indigo-500 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                                    Description
                                </h2>
                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 shadow-sm">
                                    <p className="text-gray-700">{book.description || "No description available for this book."}</p>
                                </div>
                            </div>
                    ...
                    {showNoteForm && (
                        <div className="p-8 bg-gray-50 border-t border-gray-200">
                            <h3 className="text-xl font-semibold mb-4 text-gray-800">
                                <svg className="w-5 h-5 mr-2 text-green-500 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                                Add New Note
                            </h3>
                    ...
                    {showNotes && (
                        <div className="p-8 bg-gray-50 border-t border-gray-200">
                            <h3 className="text-xl font-semibold mb-6 text-gray-800">
                                <svg className="w-5 h-5 mr-2 text-purple-500 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                                </svg>
                                Your Notes
                            </h3>
                            {notes.length === 0 ? (
                                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 text-center">
                                    ...
                                    <p className="text-gray-500">You haven't added any notes for this book yet.</p>
                                </div>
                            ) : (
                                <div className="space-y-4">
                                    {notes.map(note => (
                                        <div key={note.id} className="bg-white p-5 rounded-lg shadow-sm border border-gray-100">
