      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row items-center bg-white rounded-xl shadow-xl overflow-hidden mb-12">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 text-center md:text-left">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              ...
              Never lose track of your literary adventures again.
            </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
            ...
            <p className="text-gray-600">Keep track of your reading progress and set goals to improve your reading habits.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
            ...
            <p className="text-gray-600">Explore personalized recommendations based on your reading history and preferences.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
            ...
            <p className="text-gray-600">Create a digital collection of all your books with notes, ratings and reviews.</p>
          </div>
        </div>
      </div>
    </div>
